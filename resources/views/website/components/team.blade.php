...
<section id="team" class="section" style="background: var(--dark-bg); position:relative; overflow:hidden;">
    <div class="glow-dot" style="width:400px;height:400px;background:var(--secondary);top:50%;left:-100px;"></div>
    <div class="glow-dot" style="width:300px;height:300px;background:var(--accent);bottom:-100px;right:-100px;opacity:0.04;"></div>

    <div class="container">
        <div class="section-header" data-aos="fade-up">
            <span class="section-badge"><i class="fas fa-users"></i> Our People</span>
            <h2 class="section-title">Meet the Team</h2>
            <p class="section-subtitle">The talented professionals driving our innovation and success</p>
                        </div>
