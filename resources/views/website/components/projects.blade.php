...
<section id="projects" class="section" style="background: var(--dark-bg); position:relative; overflow:hidden;">
    <div class="glow-dot" style="width:500px;height:500px;background:var(--accent);top:-100px;right:-100px;"></div>

    <div class="container">
        <div class="section-header" data-aos="fade-up">
            <span class="section-badge"><i class="fas fa-briefcase"></i> Our Work</span>
            <h2 class="section-title">Latest Projects</h2>
            <p class="section-subtitle">Explore our innovative projects that deliver exceptional digital experiences</p>
        </div>
        ...
        <div id="projects-view-all" style="display:none;text-align:center;margin-top:3.5rem;" data-aos="fade-up">
            <a href="{{ route('projects') }}" class="btn btn-outline" style="padding:0.9rem 2.5rem;">
